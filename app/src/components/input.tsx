...
export default function MessageInput(props: MessageInputProps) {
    ...
    const openFileModal = useCallback(() => openModal({
        title: 'Suelte un archivo mp3 aquí',
        modalId: "file-modal",
        children: (
            <>
                {useOpenAIWhisper &&
                    <Dropzone
                        onDrop={async (files) => {
                            console.log('archivos caídos', files);
                    ...
                    >
                        <Group position="center" spacing="xl" style={{ minHeight: 220, pointerEvents: 'none' }}>
                            ...
                            <div>
                                <Text size="xl" inline>
                                    Arrastre archivos de audio de voz mp3 aquí o haga clic para seleccionar archivos
                                </Text>
                ...
                {!useOpenAIWhisper &&
                    <p> Habilite OpenAI Whisper en la configuración de usuario para usar la funcionalidad de transcripción de archivos.</p>
                }
            </>
        ),
            ...
            <div style={{
                ...
                {context.generating && (<>
                    <Button variant="subtle" size="xs" compact onClick={() => {
                        ...
                        <FormattedMessage defaultMessage={"Cancelar"} description="Etiqueta del botón en el que se puede hacer clic mientras la IA genera una respuesta para cancelar la generación" />
                    </Button>
