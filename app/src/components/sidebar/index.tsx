    ...
    const elem = useMemo(() => (
        <Container className={"sidebar " + (sidebarOpen ? 'opened' : 'closed')} ref={ref}>
            <div className="sidebar-header">
                <h2><FormattedMessage defaultMessage={"Historial de chats"} description="Rumbo a la pantalla de historial de chat" /></h2>
                ...
                <Menu width={width - 20}>
                    ...
                    <Menu.Dropdown>
                        <Menu.Item onClick={() => {
                            ...
                            <FormattedMessage defaultMessage={"Ajustes de usuario"} description="Elemento de menú que abre la pantalla de configuración del usuario" />
                        </Menu.Item>
                        {/*
                        <Menu.Divider />
